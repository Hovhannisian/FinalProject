...
dark.src = "buildingDark.jpg";

const rightUp = new Image();
rightUp.src = "buildingRightUp.png";

const rightDown = new Image();
rightDown.src = "buildingRightDown.png";

const leftDown = new Image();
leftDown.src = "buildingLeftDown.png";

const leftUp = new Image();
leftUp.src = "buildingLeftUp.png";
...
loop()
function next() {
	window.location.assign("html3.html")
}
